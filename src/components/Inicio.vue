  ...
  data() {
    return {
      ...
      psicologos: [
        ...
        { nombre: 'LIC. MARÍA GODARD ZAPATA', puesto: 'TERAPIA HUMANISTA', educacion: 'Tanatología, Constelaciones Familiares, problemas personales, familiares y laborales, alcoholismo, drogadicción, pérdidas, orientación sexual, aborto y divorcio.', perfil: '/Autoayuda', imagen: 'https://i.postimg.cc/Hx9THZWD/LIC-MAR-A-GODARD-ZAPATA.png'},
        ...
        { nombre: 'DR. JORGE LUIS CORTÉS LÓPEZ', puesto: 'PSIQUIATRIA DE ENLACE', educacion: 'Médico Psiquiatra, posgraduado en el Instituto Nacional de Psiquiatría “Ramón de la Fuente”', perfil: '/Autoayuda', imagen: 'https://i.postimg.cc/Kz2m6S2D/DR-JORGE-LUIS-CORT-S-L-PEZ.png'},
